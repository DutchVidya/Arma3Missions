...
_scope1 = "rhsusf_acc_T1_high";	// Holosight
...
_rifle = "hlc_smg_mp5N_tac";
_riflemag = "hlc_30Rnd_9x19_B_MP5";
_riflemag_tr = "hlc_30Rnd_9x19_B_MP5";
...
_glrifle = "hlc_smg_mp5N_tac";
_glriflemag = "hlc_30Rnd_9x19_B_MP5";
_glriflemag_tr = "hlc_30Rnd_9x19_B_MP5";
...
_baseUniform = ["demian2435_police_man_uniform"];
_baseHelmet = ["H_Cap_police"];
_baseGlasses = [];

// Vests
_lightRig = ["V_BandollierB_cbr","V_BandollierB_khk"];
_mediumRig = ["TRYK_V_tacv1_P_BK"]; 	// default for all infantry classes
...
_pilotHelmet = ["demian2435_pilot_helmet"];
_pilotRig = ["V_TacVest_blk_POLICE"];
_pilotGlasses = [];
