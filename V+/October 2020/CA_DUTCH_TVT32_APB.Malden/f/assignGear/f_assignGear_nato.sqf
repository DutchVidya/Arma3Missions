...
_scope1 = "optic_ACO_grn_smg";	// Holosight
...
_rifle = "SMG_03C_TR_black";
_riflemag = "50Rnd_570x28_SMG_03";
_riflemag_tr = "50Rnd_570x28_SMG_03";
...
_glrifle = "SMG_03C_TR_black";
_glriflemag = "50Rnd_570x28_SMG_03";
_glriflemag_tr = "50Rnd_570x28_SMG_03";
...
// Backpacks
_bagsmall = "B_TacticalPack_blk";			// carries 120, weighs 20
_bagmedium = "B_TacticalPack_blk";				// carries 240, weighs 30
_baglarge =  "B_TacticalPack_blk"; 			// carries 320, weighs 40
...
_baseUniform = ["U_B_GEN_Commander_F","U_B_GEN_Soldier_F"];
_baseHelmet = ["H_Beret_gen_F","H_MilCap_gen_F"];
_baseGlasses = [];

// Vests
_lightRig = ["V_BandollierB_cbr","V_BandollierB_khk"];
_mediumRig = ["V_TacVest_gen_F"]; 	// default for all infantry classes
...
// CARGO: CAR - room for 10 weapons and 50 cargo items
	case "v_car":
	{
		...
		_unit addWeaponCargoGlobal [rifle, 2];
