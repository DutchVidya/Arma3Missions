...
_hierarchywest = {
	...
	[_side,"CO","CO",13,[1,3],"ColorYellow",3, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR FAC

		[_side,"ALPHA","CO",1,[1,4],"ColorRed",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR ALPHA
		[_side,"BRAVO","CO",2,[1,4],"ColorRed",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR BRAVO
		[_side,"CHARLIE","CO",3,[1,4],"ColorRed",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR CHARLIE
		[_side,"DELTA","CO",4,[1,4],"ColorBlue",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR DELTA
		[_side,"ECHO","CO",5,[1,4],"ColorBlue",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR ECHO
		[_side,"FOXTROT","CO",6,[1,4],"ColorBlue",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR FOXTROT
		[_side,"GOLF","CO",7,[1,4],"ColorYellow",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR GOLF
		[_side,"HOTEL","CO",8,[1,4],"ColorYellow",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR HOTEL
		[_side,"INDIA","CO",9,[1,4],"ColorYellow",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR INDIA
		[_side,"JULIET","CO",10,[1,4],"ColorGreen",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR JULIET
		[_side,"KILO","CO",11,[1,4],"ColorGreen",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR KILO
		[_side,"LIMA","CO",12,[1,4],"ColorGreen",5, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR LIMA
};

_hierarchyeast = _hierarchywest;

_hierarchyindependent = {
	_side = _this select 0;
	[_side,"ALPHA","ALPHA",16,[1,4],"ColorPink",3, true, "b_hq"] spawn ca_fnc_setupGroup; // Radio Nets: LR CMD1 and LR FAC
