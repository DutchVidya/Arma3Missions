...
It's pretty self explanatory, list ALL your markers on that first line, and if a side is supposed 
to see a marker, it is placed in their section. So "mrkr2" and "mrkr3" are meant to be seen by Opfor.
*/
//======================================================================================
if (!isDedicated) then
{
    {_x setMarkerAlphaLocal 0} forEach ["FIA","cop1","cop2","cop3","cop4","cop5","cop6","cop7","cop8","cop"];
    waitUntil {!isNull player};
    switch (side player) do
    {
        case WEST:
        {
            {_x setMarkerAlphaLocal 1} forEach ["cop1","cop2","cop3","cop4","cop5","cop6","cop7","cop8","cop"];
        };
        case EAST:
        {
        ...
        case RESISTANCE:
        {
            {_x setMarkerAlphaLocal 1} forEach ["FIA","cop1","cop2","cop3","cop4","cop5","cop6","cop7","cop8"];
        };
        case CIVILIAN:
        {
            {_x setMarkerAlphaLocal 1} forEach [""];
